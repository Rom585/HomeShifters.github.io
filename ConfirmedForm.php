...
<section class="booking-confirmed">
    <div class="Confirm">
        <h1>Your Moving Quote is Confirmed!</h1>
    ...
    // Fetch the latest booking details. Adjust the query as needed.
    $query = "SELECT moving_to, moving_from, fullname, email, phone_number, quote_date, moving_date, moving_package FROM moving ORDER BY id DESC LIMIT 1";
    $result = mysqli_query($conn, $query);

    if ($result && mysqli_num_rows($result) > 0) {
        $row = mysqli_fetch_assoc($result);
        $moving_package = htmlspecialchars($row['moving_package']);
        ?>
        ...
        <table class="summary-table">
            <tr>
                ...
                <td>
                    <ul>
                        <li><strong>Move To:</strong> <?php echo htmlspecialchars($row['moving_to']); ?></li>
                        <li><strong>Move From:</strong> <?php echo htmlspecialchars($row['moving_from']); ?></li>
                        ...
                        <li><strong>Move Date:</strong> <?php echo htmlspecialchars($row['moving_date']); ?></li>
                    </ul>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <ul>
                        <li><strong>Moving Package:</strong> <?php echo $moving_package; ?></li>
                    </ul>
                </td>
            </tr>
            <tr>
        ...
        <script>
            const selectedPackage = '<?php echo $moving_package; ?>';
            ...
            function updatePrice() {
                ...
                if (selectedPackage === 'Basic Package') {
                    price = '6000';
                } else if (selectedPackage === 'Premium Package') {
                    price = '8500';
                } else {
                    price = '1500';
                }
